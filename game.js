...
const HASH_GROUPS = [
  ...
  { key: "rose", name: "玫瑰入口", color: "#e6397a", icon: "玫瑰" },
  { key: "coral", name: "珊瑚入口", color: "#ff5a5f", icon: "珊瑚" },
  { key: "peach", name: "蜜桃入口", color: "#ffb38a", icon: "蜜桃" },
  { key: "amber", name: "琥珀入口", color: "#ffbf00", icon: "琥珀" },
  { key: "lemon", name: "檸檬入口", color: "#f7f700", icon: "檸檬" },
  { key: "olive", name: "橄欖入口", color: "#8a9a0a", icon: "橄欖" },
  { key: "forest", name: "森林入口", color: "#166534", icon: "森林" },
  { key: "teal", name: "藍綠入口", color: "#008080", icon: "藍綠" },
  { key: "cyan", name: "青色入口", color: "#20e3f2", icon: "青色" },
  { key: "sky", name: "天空入口", color: "#7cc7ff", icon: "天空" },
  { key: "cobalt", name: "鈷藍入口", color: "#0047ab", icon: "鈷藍" },
  { key: "indigo", name: "靛藍入口", color: "#3f37c9", icon: "靛藍" },
  { key: "lavender", name: "薰衣草入口", color: "#b197fc", icon: "薰衣草" },
  { key: "plum", name: "梅紫入口", color: "#6d214f", icon: "梅紫" },
  { key: "tan", name: "駝色入口", color: "#d2b48c", icon: "駝色" },
  { key: "copper", name: "銅色入口", color: "#b87333", icon: "銅色" },
  { key: "silver", name: "銀灰入口", color: "#c0c0c0", icon: "銀灰" },
  { key: "charcoal", name: "炭灰入口", color: "#36454f", icon: "炭灰" },
];
